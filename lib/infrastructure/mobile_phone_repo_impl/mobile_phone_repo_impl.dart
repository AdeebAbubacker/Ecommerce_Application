...
@LazySingleton(as: MobilephoneRepo)
class MobilePhoneRepoImpl implements MobilephoneRepo {
  @override
  Future<Either<MainFailure, List<MobilePhone>>> getMobilephones() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return Right(result.ecommercedta!.mobilePhone!.toList());
      } else {
