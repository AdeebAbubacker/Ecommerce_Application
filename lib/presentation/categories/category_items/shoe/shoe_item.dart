...
import 'package:ecommerce_app/presentation/view_item/shoeview_item/shoe_view_item.dart';
...
class _SHoePageState extends State<SHoePage> {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      BlocProvider.of<ShoeBloc>(context).add(const ShoeEvent.getShoes());
    });
    return Scaffold(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            Navigator.push(context, MaterialPageRoute(
                              builder: (context) {
                                return ShoeViewItem(selctedIndex: selctedIndex);
                              },
                            ));
                          },
                          child: Container(
                            ...
                            child: Column(children: [
                              Image.network(
                                '${state.shoes[index].imgUrl}',
                                width: 90,
                                height: 100,
                              ),
                              Text(
                                '${state.shoes[index].brand}',
                                style: ksize14b,
                              ),
                              Text(
                                '(${state.shoes[index].model})',
                                style: ksize10,
                              ),
                              SizedBox(
                                height: 10,
