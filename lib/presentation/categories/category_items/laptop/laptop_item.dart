...
import 'package:ecommerce_app/presentation/view_item/laptop_view_item.dart/laptop_view_item.dart';
...
class _LaptopPageState extends State<LaptopPage> {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      BlocProvider.of<LaptopBloc>(context).add(const LaptopEvent.getLaptop());
    });
    return Scaffold(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Column(children: [
                              Image.network(
                                '${state.laptops[index].imgUrl}',
                                width: 90,
                                height: 100,
                              ),
                              Text(
                                '${state.laptops[index].brand}',
                                style: ksize14b,
                              ),
                              Text(
                                '(${state.laptops[index].model})',
                                style: ksize10,
                              ),
                              SizedBox(
                                height: 10,
